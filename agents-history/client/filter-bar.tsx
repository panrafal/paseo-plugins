...
/**
 * Every way to narrow the list: the search text (metadata instantly, transcripts through grep
 * once typing pauses or Enter is pressed), then dropdowns for archived state, provider, project,
 * and period, and two toggles that change how grep reads the text. Dropdowns wrap onto further
 * rows on a phone.
 */
    ...
    <View style={styles.bar}>
      ...
      <View style={styles.selectors}>
        ...
        <Chip
          ...
          theme={theme}
          accessibilityHint="Treat the search text as an extended regular expression"
        />
        <Chip
          label="Aa"
          icon="CaseSensitive"
          ...
          theme={theme}
          accessibilityHint="Match the letter case exactly"
        />
      </View>
