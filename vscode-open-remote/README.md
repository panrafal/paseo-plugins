...
Open the Paseo Command Center with **Cmd+K** or **Ctrl+K**, then choose **Configure remote editor**
to select VS Code, Cursor, or an arbitrary URI prefix. The setting is stored under
